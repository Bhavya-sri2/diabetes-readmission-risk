...
The binary target `readmitted_30d` was defined as 1 if `readmitted == "<30"`, else 0. The resulting class distribution is 91.0% negative / 9.0% positive — a substantial imbalance that shaped both the modeling and evaluation strategy.
